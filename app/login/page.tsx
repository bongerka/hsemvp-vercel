    ...
    <main className="flex flex-1 items-center justify-center px-4 py-10 sm:px-6">
      <div className="grid w-full max-w-5xl gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <Card className="overflow-hidden">
          <CardContent className="space-y-6 px-6 py-8 md:px-8">
            <div className="inline-flex items-center gap-2 rounded-full bg-accent px-4 py-2 text-sm font-medium text-accent-foreground">
              ...
              Вход для администратора клиники
            </div>
            <div className="space-y-3">
              ...
              <p className="text-sm leading-6 text-muted-foreground">
                Введите рабочий email — мы отправим ссылку для входа. Пароль запоминать не нужно.
              </p>
            </div>
        ...
        <Card className="overflow-hidden bg-[#16381f] text-white">
          <CardHeader>
            <CardTitle className="text-3xl text-white">Что в кабинете</CardTitle>
            <CardDescription className="text-white/70">
              Всё, что нужно администратору клиники, в одном окне.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 text-sm leading-6 text-white/85">
            <div className="rounded-[24px] bg-white/10 p-4">
              Заявки с контактами пациентов и фильтром по статусам.
            </div>
            <div className="rounded-[24px] bg-white/10 p-4">
              История диалогов из Telegram и чата на сайте.
            </div>
            <div className="rounded-[24px] bg-white/10 p-4">
              Статистика обращений и конверсии в заявки.
            </div>
